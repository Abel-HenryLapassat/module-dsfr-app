...
const currentScheme = document.documentElement.getAttribute('data-fr-scheme') || 'system';
const currentRadio = document.querySelector(`input[name="fr-radios-theme"][value="${currentScheme}"]`);
